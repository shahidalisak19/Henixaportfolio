...
//   useEffect(() => {
//     document.title = 'Contact 3Cs Software Development Company | Get Free Quote';
    
//     const metaDescription = document.querySelector('meta[name="description"]');
//     if (metaDescription) {
//       metaDescription.setAttribute('content', 'Contact 3Cs Software Development Company for custom software solutions. Get a free quote for web development, mobile apps, and enterprise software. 24-hour response guaranteed.');
//     }
//   }, []);
...
//     const body = `
// New Project Inquiry from 3Cs Contact Form
...
//                 />
//                 <div>
//                   <h1 className="text-xl font-bold text-stone-900">3Cs</h1>
...
//                   By submitting, you agree to receive project-related communications from 3Cs
//                 </p>
//               </div>
//             </motion.div>
//           </div>
...
//               <p className="font-semibold mb-2">© 2024 3Cs Software Development Company</p>
...
//           <h1>Contact 3Cs Software Development Company | Get Free Quote</h1>
//           <p>
//             Contact 3Cs Software Development Company for custom software solutions, web application development, mobile app development, and enterprise software services. Get a free consultation and detailed project quote within 24 hours.
//           </p>
//           <h2>Request Software Development Services</h2>
//           <p>
//             Fill out our contact form to start your software development project with 3Cs. Our expert development team specializes in custom software development, web applications using React and Next.js, mobile apps with React Native and Flutter, cloud solutions on AWS and Azure, and enterprise software systems.
//           </p>
//           <h2>Free Software Development Consultation</h2>
//           <p>
//             3Cs offers free consultation for all software development projects. Whether you need a custom CRM system, e-commerce platform, SaaS application, or mobile app, our team provides expert guidance on technology stack, architecture design, development timeline, and project budget.
//           </p>
...
//           </ul>
//           <p>
//             Start your software development project today with 3Cs. Our proven track record includes 200+ successfully delivered projects, 99.8% client satisfaction rate, and expertise in 50+ modern technologies. Contact us now for a free consultation and transform your business with custom software solutions.
//           </p>
//         </div>
//       </div>
//     </div>
