    ...
    <p className="text-xs text-stone-600">Software Solutions</p>
            ...
            {mobileMenuOpen && (
              ...
              >
                ...
                <div className="flex flex-col gap-2 pt-2">
                  <a href="#portfolio" className="px-5 py-2.5 border-2 border-emerald-600 text-emerald-700 rounded-lg font-semibold text-center">
                    View Projects
                  </a>
                  <a href="#quote" className="px-5 py-2.5 bg-gradient-to-r from-emerald-600 to-teal-600 text-stone-50 rounded-lg font-semibold text-center">
                    Get Quote
                  </a>
                </div>
              </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              >
                ...
                <p className="text-stone-600">End-to-end development solutions for modern businesses</p>
              </motion.div>
                ...
                {services.map((service, index) => (
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <span className="text-lg font-semibold text-stone-800">{service.text}</span>
                    </div>
                  </motion.div>
                ))}
              </div>
            ...
            <div>
              ...
              >
                ...
                <p className="text-stone-600">Numbers that speak for our excellence</p>
              </motion.div>
        ...
        <section id="technologies" className="max-w-7xl mx-auto px-6 py-16">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {["React/Next.js", "Node.js", "Python/Django", "Java/Spring", "PHP/Laravel", "React Native", "Flutter", "AWS/Azure", "Docker/Kubernetes", "PostgreSQL/MongoDB", "GraphQL/REST", "TypeScript"].map((tech, index) => (
              <motion.div
                key={index}
        ...
        <section id="contact" className="max-w-7xl mx-auto px-6 py-20">
          ...
          >
            ...
            <div className="relative z-10">
              <h3 className="text-4xl md:text-5xl font-bold text-stone-50 mb-4">
                Ready to Build Your Software Solution?
              </h3>
              <p className="text-xl text-stone-100 mb-4 max-w-2xl mx-auto">
                Partner with Henixa Software Development Company and transform your business with custom software
              </p>
              <p className="text-lg text-stone-100/90">
