      ...
      <div className="relative z-10">
        ...
        <section className="min-h-screen flex items-center justify-center px-6 pt-20">
          <div className="max-w-6xl mx-auto text-center">
            ...
            >
              3Cs builds scalable, enterprise-grade custom software solutions that transform businesses. From web applications to mobile apps and cloud services, we deliver excellence.
            </motion.p>
          ...
          >
            <div className="relative overflow-hidden rounded-3xl border border-gray-800">
              ...
              <div className="relative z-10 p-12 md:p-16 text-center">
                ...
                >
                  Partner with 3Cs Software Development Company and transform your business with custom software
                </motion.p>
        ...
        <div className="sr-only" id="about">
          <h1>3Cs - Leading Software Development Company | Custom Solutions</h1>
          <p>
            3Cs Software Development Company is a premier provider of custom software development services, specializing in web application development, mobile app development, and enterprise software solutions. With over 200 successfully delivered software projects and a 99.8% client satisfaction rate, 3Cs has established itself as a trusted partner for businesses seeking digital transformation.
          </p>
          ...
          <p>
            3Cs's team of certified software engineers and developers are proficient in 50+ modern technologies and frameworks. Our expertise spans across frontend development (React, Next.js, Vue.js), backend development (Node.js, Python, Java, PHP), mobile development (React Native, Flutter), cloud services (AWS, Azure, Google Cloud), and DevOps practices (Docker, Kubernetes, CI/CD pipelines).
          </p>
          <h2>Why Choose 3Cs Software Development Company</h2>
          <p>
            With proven expertise in agile development methodologies, Test-Driven Development (TDD), and continuous integration/continuous deployment (CI/CD), 3Cs delivers high-quality software solutions on time and within budget. Our client-centric approach ensures that every software project aligns with business objectives and delivers measurable ROI.
          </p>
          <ul>
          ...
          <p>
            Contact 3Cs Software Development Company today for a free consultation and project estimate. Let our expert development team transform your business vision into a powerful software reality. Whether you need a minimum viable product (MVP), enterprise software upgrade, or complete digital transformation, 3Cs has the expertise to deliver excellence.
          </p>
        </div>
      </div>
    </div>
